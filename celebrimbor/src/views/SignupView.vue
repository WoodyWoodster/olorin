      ...
      <Card class="border-stone-200 shadow-xl">
        <CardHeader class="space-y-1 pb-6">
          <CardTitle class="text-2xl font-bold text-center text-stone-900"
            >Create your organization</CardTitle
          >
        ...
        <CardContent>
          <form @submit.prevent="handleSignup" class="space-y-4">
            ...
            <div class="space-y-2">
              <Label for="organization_name" class="text-stone-700 font-medium"
            ...
            <div class="space-y-2">
              <Label for="password_confirmation" class="text-stone-700 font-medium"
