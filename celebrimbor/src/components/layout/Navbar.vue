    ...
    <div class="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-3">
          ...
          <h1 class="hidden text-lg font-bold text-stone-900 sm:block">Olorin</h1>
        </div>
        ...
        >
          ...
          <kbd class="hidden rounded bg-white px-1.5 py-0.5 text-xs text-stone-500 sm:inline"
            >⌘K</kbd
          >
        </button>
      </div>
      ...
      <div class="flex items-center space-x-4">
        <DropdownMenu>
          <DropdownMenuTrigger as-child>
            <Button variant="ghost" class="relative flex items-center space-x-3 hover:bg-stone-100">
              <Avatar>
